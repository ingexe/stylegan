...
def training_loop(
    ...
    resume_run_id           = 'results/00003-sgan-shoes-1gpu',  # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 3285.0,   # Assumed training progress at the beginning. Affects reporting and training schedule.
